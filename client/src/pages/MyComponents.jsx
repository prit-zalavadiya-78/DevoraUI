...
const MyComponents = () => {
  ...
  const { allComponents, userData } = useSelector(state => state.user);
    ...
    >
      ...
      <nav className='sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-4 border-b border-white/[0.05] bg-[#030b0d]/90 backdrop-blur-md shrink-0'>
        ...
        <div className="flex flex-1 overflow-hidden" style={{ height: "calc(100vh - 57px)" }}>
            ...
            <SidebarComponent selected={selected} setSelected={setSelected} search={search} setSearch={setSearch} myComponents={myComponents} onSelect={handleSelect}/>
            </aside>
