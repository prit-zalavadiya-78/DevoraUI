...
function CopyBtn({text}){
  ...
  return(
    <div onClick={handleCopy} className='flex items-center gap-1.5 text-[11px] text-white/30 hover:text-white/60 transition-colors bg-transparent border-none cursor-pointer px-2 py-1 rounded-lg hover:bg-white/[0.04]'>
        ...
        <div className='w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#3be8ff]/[0.07] border border-[#3be8ff]/15 flex items-center justify-center mx-auto mb-5 sm:mb-6'>
          ...
          <div className='w-full max-w-md mx-auto text-left space-y-4 mb-8'>
            ...
            <div>
              ...
              <CodeBlock code="npm install devora-ui" lang="bash"/>
            </div>

            <div>
              <p className='text-xs text-white/40 mb-2 flex items-center gap-1.5'>
                <span className="text-[#3be8ff]/60 font-bold">02</span> Import your components
              </p>
              <CodeBlock code="import { componentName } from 'devora-ui'" lang="jsx"/>
            </div>
            ...
            <div>
              ...
              <CodeBlock code={`import { UserAvatar, PricingCard } from 'devora-ui';\n\nexport default function App() {\n  return (\n    <div>\n      <UserAvatar src="/user.png" />\n      <PricingCard title="Pro" price={99} />\n    </div>\n  );\n}`} lang='jsx'/>
            </div>
          </div>
    ...
    >
      ...
      <nav className='sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-4 border-b border-white/[0.05] bg-[#030b0d]/90 backdrop-blur-md shrink-0'>
        ...
        <div className="flex flex-1 overflow-hidden" style={{ height: "calc(100vh - 57px)" }}>
            ...
            <SidebarComponent selected={selected} setSelected={setSelected} search={search} setSearch={setSearch} publicComponents={publicComponents} onSelect={handleSelect}/>
            </aside>
