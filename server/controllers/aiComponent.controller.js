...
const generateComponent = async (req, res) => {
    try {
        ...
        const messages = [{
            ...
            {
            "name": "ComponentName",
            "code": "<full component code as a single escaped string>",
            "props": ["prop1", "prop2"]
            }
            ...
            - The code inside the JSON string must be nicely formatted and readable.
            - Preserve normal JavaScript/JSX indentation exactly as if it were a real source file.
            - Do NOT collapse or minify code formatting.
            - Use consistent 2-space indentation for nested blocks, JSX, props, and object literals.
            ...
            --- BRANDING RULES ---
            - Use Devora UI as the product brand.
            - Use devora-ui where a library/package name is needed.
            - Replace any old branding references like VirtualAI or virtual-ui-library with Devora UI / devora-ui.
        ...
        return res.status(200).json({ message: "Component generated successfully", parsedContent, remainingCredits: user.role==="user"?user.aiCredits:null});
